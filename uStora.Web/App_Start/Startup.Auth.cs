    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "322566312057593",
               appSecret: "2e3a89ab48155df7e494a6aae52e1373");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "861035457442-8uqv2jd3bge5rnmt2j6b10q94mh8jtmb.apps.googleusercontent.com",
                ClientSecret = "tFT5nbvqgneoNQ3j-pgIGTC5"
			});
        }
